...
//import TowersOfHanoiWithControls.Display;
 ...
 */
public class HanoiVersion3 extends JPanel implements Runnable, ActionListener {
	   ...
	   public static void main(String[] args) {
	      JFrame window = new JFrame("T-o-w-e-r-s O-f H-a-n-o-i");
	   ...
	   private static Color DISK_COLOR = new Color(2,123,180);
	   ...
	   public Panel display;  // A subpanel where the frames of the animation are shown.
